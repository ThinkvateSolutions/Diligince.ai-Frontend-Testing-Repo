...
import NotificationDropdown from "./NotificationDropProduct";
import ProfileDropdown from "./ProfileDropProduct";

const ProductVendorHeader = () => {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  const navItems = [
    { label: "Dashboard", icon: <Home size={18} />, href: "/product-vendor-dashboard" },
    { label: "RFQs", icon: <FileText size={18} />, href: "/product-vendor-rfqs" },
    { label: "Catalog", icon: <LayoutGrid size={18} />, href: "/product-vendor-catalog" },
    { label: "Orders", icon: <ShoppingCart size={18} />, href: "/product-vendor-orders" },
    { label: "Messages", icon: <MessageSquare size={18} />, href: "/product-vendor-messages" },
  ];
...
export default ProductVendorHeader;

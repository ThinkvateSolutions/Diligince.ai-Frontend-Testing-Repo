  ...
  const getProfileData = () => {
    switch (profileType) {
      ...
      case "product-vendor":
        ...
        return {
          name: "TransLog India",
          subtext: "TransLog.com",
          color: "bg-[#eb2f96]",
          baseRoute: "/logistics-vendor-profile",
          menuItems: [
            // FIXED MENU ITEMS:
            { label: "Company Info", icon: <User />, section: "company-info" },
            { label: "Fleet & Equipments", icon: <Truck />, section: "fleet-equipments", hideOnDesktop: true },
            { label: "Service Areas", icon: <MapPin />, section: "service-areas", hideOnDesktop: true },
            { label: "Licenses & Permits", icon: <Package />, section: "licenses-permits", hideOnDesktop: true },
            { label: "Drivers & Personnel", icon: <Users />, section: "drivers-personnel", hideOnDesktop: true },
            { label: "Payment Settings", icon: <CreditCard />, section: "payment-settings" },
            { label: "Account Settings", icon: <Settings />, section: "account-settings" },
          ],
        };

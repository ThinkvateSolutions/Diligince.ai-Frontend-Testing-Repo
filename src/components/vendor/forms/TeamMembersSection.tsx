    ...
    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
      ...
      <div className="flex flex-col">
        <div className="flex items-center">
          <h1 className="text-2xl font-bold text-gray-900 mr-2">Team Members</h1>
          <button
            type="button"
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-end">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <Label htmlFor="single" className="text-sm">Single User</Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="multiple" id="multiple" />
              <Label htmlFor="multiple" className="text-sm">Multiple Users</Label>
            </div>
          </RadioGroup>
        </div>
        ...
        <Dialog open={showAddModal} onOpenChange={setShowAddModal}>
          <DialogTrigger asChild>
            <Button className="bg-orange-600 hover:bg-orange-700 text-white font-medium shadow-sm mt-[10px]">
              {editId ? "Update" : "Add"}
...
{/* Document */}
<div className="space-y-2">
  <Label htmlFor="document">Letter Pad Document (PDF, PNG, JPG)</Label>

...
/>
    ...
    <div className="flex items-center text-red-600">
      ...
      <span>Verification failed. Please try again later.</span>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {isEditing && (
                        <Button type="button"  onClick={handleVerifyGst} disabled={isVerifyingGst || !field.value} className="bg-yellow-600 text-white hover:bg-yellow-700" >
    ...
    <div className="flex items-center text-red-600">
      ...
      <span>Verification failed. Please try again.</span>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {isEditing && (
                        <Button type="button"  onClick={handleVerifyRegNo} disabled={isVerifyingRegNo || !field.value} className="bg-yellow-600 text-white hover:bg-yellow-700" >
        ...
        <span>Verified</span>
                   ...
                   <div className="flex items-center space-x-2">
                     <div className="relative flex-grow">
                      ...
                      {isEditing && !emailVerified && <Button className="bg-yellow-600 text-white hover:bg-yellow-700" type="button"  onClick={() => handleSendOtp('email')} disabled={isSendingEmailOtp || emailTimer > 0 || !!form.getFieldState('email').error}>  
        ...
        <span>Verified</span>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="mt-2 p-3 bg-gray-50 rounded-md border space-y-2">
                            ...
                            <Button type="button"className="bg-yellow-600 text-white hover:bg-yellow-700 w-full sm:w-auto" onClick={() => handleVerifyOtp('mobile')} disabled={isVerifyingMobileOtp || mobileOtp.length !== 4}>
  ...
  <FormMessage>{form.formState.errors.addresses?.message}</FormMessage>
           ...
           <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-foreground">Product Categories</FormLabel>
                  <FormControl>
                    {isEditing ? (
                      <MultiSelect

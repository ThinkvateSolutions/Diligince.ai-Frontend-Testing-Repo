          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={form.formState.errors.companyName ? "text-black" : ""}>Company Name</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={form.formState.errors.yearEstablished ? "text-black" : ""}>Year Established</FormLabel>
                    <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className={form.formState.errors.industryFocus ? "text-black" : ""}>Industry Focus</FormLabel>
                  <FormControl>
                    <MultiSelect
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className={form.formState.errors.companyDescription ? "text-black" : ""}>Company Description</FormLabel>
                  <FormControl>
                    <Textarea 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={form.formState.errors.gstNumber? "text-black" : ""}>GST Number</FormLabel>
                    <FormControl>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={form.formState.errors.email ? "text-black" : ""}>Email Address</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={form.formState.errors.phone ? "text-black" : ""}>Phone Number</FormLabel>
                    <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className={form.formState.errors.address ? "text-black" : ""}>Address</FormLabel>
                  <FormControl>
                    <Textarea 

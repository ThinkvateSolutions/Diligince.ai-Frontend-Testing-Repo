...
import { toast } from "sonner";
  ...
  issuingAuthority: z.string()
    ...
    .regex(/^[A-Za-z\s,.'()&-]+$/, {
      message: "Only letters, commas, and punctuation allowed",
    }),
  ...
  return issue.toString() !== "Invalid Date" &&
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.verificationStatus? "text-black" : ""}>Verification Status</FormLabel>
                        <Select onValueChange={field.onChange} value={field.value}>
                          <FormControl>
                            <SelectTrigger>

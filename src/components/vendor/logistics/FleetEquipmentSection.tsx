...
export const FleetEquipmentSection = () => {
  ...
  render={({ field }) => (
    <FormItem>
      <FormLabel className={form.formState.errors.quantity ? "text-black" : ""}>Quantity</FormLabel>
      <FormControl>
        <Input
          type="number"
...
/>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.make ? "text-black" : ""}>Make</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.model? "text-black" : ""}>Model</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.year ? "text-black" : ""}>Year</FormLabel>
                        <FormControl>
    ...
    render={({ field }) => (
      <FormItem>
        <FormLabel className={form.formState.errors.capacity ? "text-black" : ""}>Capacity</FormLabel>
        <FormControl>
          <Input
            type="number"
            min={0} // Prevents negative numbers
  ...
  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.unit ? "text-black" : ""}>Unit</FormLabel>
                        <Select onValueChange={field.onChange} value={field.value}>
                          <FormControl>
                            <SelectTrigger>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.registrationNumber ? "text-black" : ""}>Registration Number</FormLabel>
                        <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className={form.formState.errors.features? "text-black" : ""}>Features & Specifications</FormLabel>
                      <FormControl>
                        <Textarea 
  ...
  render={({ field }) => (
    <FormItem>
      <FormLabel className={form.formState.errors.location ? "text-black" : ""}>Base Location</FormLabel>
      <FormControl>
        <Input
...
/>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className={form.formState.errors.status? "text-black" : ""}>Availability Status</FormLabel>
                        <Select onValueChange={field.onChange} value={field.value}>
                          <FormControl>
                            <SelectTrigger>
